...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2023 at 04:26 PM
...
INSERT INTO `admin` (`admin_id`, `admin_fname`, `admin_lname`, `admin_email`, `admin_position`, `admin_password`, `admin_status`) VALUES
(1, 'Admin', 'Admin', 'Admin', 'Admin', 'AAECAwQFBgcICQoLDA0ODylluTeod5rYdTb8UC8fEg0=', 'active');
...
(13, 'Moby-Dick', 'Herman Melville', 'Fiction', '1851-10-18', 'Harper & Brothers', 'Checked out', 1),
...
(25, 'The Hunger Games', 'Suzanne Collins', 'Young Adult', '2008-09-14', 'Scholastic Corporation', 'Checked out', 2),
...
(37, 'Test 9', 'Book Author', 'Classic', '1949-06-08', 'Arthur', 'Available', 13),
...
INSERT INTO `borrowed_book` (`borrow_id`, `book_id`, `patron_id`, `borrowed_date`, `borrowed_due_date`) VALUES
(11, 25, 'G82NZx3v', '2023-05-31', '2023-06-21'),
(12, 13, 'OGVcK5xd', '2023-05-31', '2023-06-21');
...
CREATE TABLE `reserved_book` (
  ...
  `reservation_queue` int(11) NOT NULL,
